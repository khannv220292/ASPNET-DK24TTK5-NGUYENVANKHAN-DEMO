...
conn = pyodbc.connect(
    "Driver={ODBC Driver 17 for SQL Server};Server=localhost;Database=laptopstore;Trusted_Connection=yes;"
)
cur = conn.cursor()
...
hps = [
    (5, "Elitebook 6 G11", 35900000, 42590000, 8, 5, 1, "U7-255H / 16GB / 512GB / 14 WUXGA",
     "<p><b>Laptop HP Elitebook 6 G11 - BQ9N4PT</b> (Nguá»“n: phongvu.vn/c/laptop-hp).</p><p>CPU Ultra 7-255H, Intel Graphics, RAM 16GB, SSD 512GB, 1.4kg, 14 inch WUXGA IPS. Windows 11.</p><p>GiÃ¡ niÃªm yáº¿t 43.490.000Ä‘, bÃ¡n 42.590.000Ä‘.</p>"),
...
new_rows = [
    (17, "HP 14 em0023AU", 17990000, 20990000, 15, 6, 1, "R5 7520U / 16GB / 512GB / 14 FHD",
     "<p><b>Laptop HP 14 em0023AU - D0BG7PA</b>.</p><p>Ryzen 5 7520U, AMD Radeon, 16GB, 512GB, 1.4kg, 14 FHD IPS. Tiáº¿t kiá»‡m 3.000.000Ä‘.</p>"),
    ...
    (19, "HP 14-hc0028TU", 21000000, 24990000, 12, 6, 1, "Ultra 5-225U / 16GB / 512GB / 14 FHD",
     "<p><b>HP 14-hc0028TU - D72BJPA</b> Win 11 Home SL.</p><p>U5-225U, 16GB, 512GB, 1.4kg, 14 FHD 60Hz. Tiáº¿t kiá»‡m 4.000.000Ä‘.</p>"),
    (20, "HP 14-ep1012TU", 20500000, 23490000, 9, 6, 1, "Core 5 120U / 16GB / 512GB / 14 FHD",
     "<p><b>HP 14-ep1012TU - D72CPPA</b>. Tráº£ gÃ³p 0%.</p><p>Core 5 120U, 16GB, 512GB, 1.4kg, 14 FHD.</p>"),
    ...
    (22, "HP 250R G10", 18900000, 22490000, 11, 5, 1, "Core 5 120U / 16GB / 512GB / 15.6 FHD",
     "<p><b>HP 250R G10 - C3SH7AT</b>. Tiáº¿t kiá»‡m 6.300.000Ä‘.</p><p>Core 5 120U, 16GB, 512GB, 1.6kg, 15.6 FHD IPS.</p>"),
    ...
    (24, "Victus 15 RTX4050", 25000000, 28990000, 8, 6, 1, "i5-13420H / RTX 4050 / 16GB / 512GB",
     "<p><b>HP Victus 15 fa2732TX - B85LPPA</b> gaming.</p><p>i5-13420H, RTX 4050, 16GB, 512GB, 2.2kg, 15.6 FHD 144Hz. Tráº£ gÃ³p 0%.</p>"),
    ...
    (26, "ProBook 4 G1i", 28000000, 32490000, 7, 5, 1, "Ultra 7-255U / 16GB / 512GB / 14 WUXGA",
     "<p><b>HP ProBook 4 G1i - BQ5C7PT</b>. Tiáº¿t kiá»‡m 6.700.000Ä‘.</p><p>Ultra 7-255U, 16GB, 512GB, 1.4kg, 14 WUXGA IPS 60Hz.</p>"),
]
